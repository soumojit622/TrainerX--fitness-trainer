  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
        ...
        {/* Copyright */}
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} TrainerX. All rights reserved.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 mt-4 md:mt-0">
            <div className="flex flex-col sm:flex-row items-center gap-2 mt-4 md:mt-0">
              ...
              <span className="hidden sm:inline-block text-gray-600 mx-2">|</span>

              <p className="text-gray-400 text-sm text-center">
                Made with 🤍 by <span className="text-cyan-500 font-semibold">Soumojit Banerjee</span>
              </p>
            </div>
